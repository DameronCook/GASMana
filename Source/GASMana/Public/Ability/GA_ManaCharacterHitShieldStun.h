...
#include "GA_ManaCharacterHitShieldStun.generated.h"

/**
 * 
 */
UCLASS()
class GASMANA_API UGA_ManaCharacterHitShieldStun : public UGameplayAbility
{
	GENERATED_BODY()

	UGA_ManaCharacterHitShieldStun();
